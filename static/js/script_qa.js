...
camera.position.set(-135, 250, 932); // 更新相機位置，使其從正面看模型
...
let mixer;
let currentModel;
const modelPaths = ['/static/models/Idle.fbx', '/static/models/think.fbx','/static/models/clapping.fbx','/static/models/correct.fbx','/static/models/sad.fbx','/static/models/wrong.fbx','/static/models/talk1.fbx','/static/models/talk2.fbx','/static/models/talk3.fbx'];
let currentIndex = 0;
